...
ДАННЫЕ ИЗ БАЗЫ (используй их как приоритет):
{context_text if context_text else "Конкретных цифр по этой специальности в базе нет, отвечай по общим правилам вуза."}
